...
該研究把同一個提問再推一步：不是交換影像，而是先讓模型自己寫出理由、固定住這段文字後才替換影像，量的是中介被封住後影像還剩多少直接貢獻: [抽掉影像、留下理由：VLM 在 anti-VEGF 治療決策裡，OCT 到底出了多少力？](2026-09-23-vlm-oct-image-dependence-audit.md)
