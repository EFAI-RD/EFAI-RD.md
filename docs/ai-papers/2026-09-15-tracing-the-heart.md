...
nMAS 把病歷欄位抽出來供下游使用，該研究則量測上游那一步在不同院所能做到多準，以及三種技術路線各自的錯誤型態: [規則引擎、GPT-4o 與微調小模型，誰讀得懂病歷裡的老年照護？四家院所、41 個構念的基準](2026-09-24-llm-geriatric-ehr-multisite-benchmark.md)
